...
<Callout type="info">
  Pair this with [Policy Packs](/docs/frameworks/next/policy-packs) when you want to exercise multiple regional UI states locally before wiring a live backend.
</Callout>
